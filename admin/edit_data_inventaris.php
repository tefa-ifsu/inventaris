...
$query = "SELECT * FROM barang_inventaris WHERE id_barang=$id_barang";
...
if(isset($_POST['ubah']))
        {
            ...
            mysqli_query($con, "UPDATE barang_inventaris 
            SET kode_barang='$kode_barang', nama_barang='$nama_barang', deskripsi_barang='$deskripsi_barang', kategori_barang='$kategori_barang', harga_barang='$harga_barang', stok_barang='$stok_barang',
             tanggal_pembelian='$tanggal_pembelian' WHERE kode_barang='$kode_barang'") or die(mysqli_error($con));

            echo "<div align='center'><h5 class='notif'> Silahkan Tunggu, Data Sedang DiUpdate.... </h5></div>";
            echo "<meta http-equiv='refresh' content='1;url=http://localhost/inventaris-main/admin/data_inventaris.php'>";
        }
  ...
  <main class="main">
    ...
    <form action="" method="POST">
      ...
      <div class="col">
        <div class="teksbox">
          <p>Nama Barang</p>
          <input type="text" name="nama_barang" placeholder="Nama Barang" required value="<?php echo $row['nama_barang']; ?>">
        </div>
        <div class="teksbox">
          <p>Kode Barang</p>
          <input type="text" name="kode_barang" placeholder="Kode Barang" required value="<?php echo $row['kode_barang']; ?>">
        </div>
      </div>
      ...
      <div class="col">
        ...
        <div class="teksbox">
          <p>Harga Barang</p>
          <input type="text" name="harga_barang" placeholder="Rp." required value="<?php echo $row['harga_barang']; ?>">
        </div>
      </div>
      ...
      <div class="col">
        <div class="teksbox">
          ...
          <input type="date" name="tanggal_pembelian" placeholder="Nama Barang" required value="<?php echo $row['tanggal_pembelian']; ?>">
        </div>
        <div class="teksbox">
          <p>Stok Barang</p>
          <input type="number" name="stok_barang" placeholder="Stok Barang" required value="<?php echo $row['stok_barang']; ?>">
        </div>
      </div>
      ...
      <div class="col">
        <div class="deskripsi">
          <p>Deskripsi  </p>
          <textarea name="deskripsi_barang" id="" required value="<?php echo $row['deskripsi_barang']; ?>"></textarea>
        </div>
      </div>
