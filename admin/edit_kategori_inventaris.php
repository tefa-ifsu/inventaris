...
$query = "SELECT * FROM kategori_barang_inventaris WHERE id_kategori=$id_kategori";
...
if(isset($_POST['ubah']))
        {
            ...
            mysqli_query($con, "UPDATE kategori_barang_inventaris 
            SET nama_kategori='$nama_kategori', ket='$ket' WHERE id_kategori='$id_kategori'") or die(mysqli_error($con));
  ...
  <main class="main">
    ...
    <form action="" method="POST">
      ...
      <div class="col">
        <div class="teksbox">
          <p>Nama Kategori</p>
          <input type="text" name="nama_kategori" placeholder="Nama Kategori" required value="<?php echo $row['nama_kategori']; ?>">
        </div>
      </div>
      ...
      <div class="col">
        <div class="deskripsi">
          <p>Deskripsi  </p>
          <textarea name="ket" id="" ><?php echo $row['ket']; ?></textarea>
        </div>
      </div>
